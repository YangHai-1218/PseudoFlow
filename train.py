...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/flow_refine/mvc_raft_flow.py', help='train config file path')
    parser.add_argument('--work-dir', type=str, help='working dir')
    parser.add_argument('--mode', choices=['refiner', 'estimator'], default='refiner')
