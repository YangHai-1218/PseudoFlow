...
data = dict(
    ...
    val=dict(
        ...
        ref_annots_root='data/reference_poses/detect_wdr/ycbv_pbr_temp_2',
        image_list=dataset_root + '/image_lists/draw.txt',
        keypoints_json=dataset_root + '/keypoints/bbox.json',
    ...
    test=dict(
        ...
        # ref_annots_root='data/reference_poses/detect_wdr/ycbv_pbr_full',
