...
train_pipeline = [
    ...
    dict(type='HandleSymmetry', symmetry_types=symmetry_types),
...
#     dict(type='Collect', 
#         annot_keys=[
#             'labels', 'k', 'ref_keypoints_3d', 'gt_keypoints_2d'
#         ],
#         meta_keys=(
#             'img_path', 'ori_shape', 'img_shape', 'img_norm_cfg', 'ori_k',
#             'scale_factor', 'transform_matrix', 'geometry_transform_mode'),
#     ),
# ]
