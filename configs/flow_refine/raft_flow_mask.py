_base_ = '../refine_datasets/ycbv_pbr.py'
...
# data = dict(
#     test=dict(
#         ref_annots_root='work_dirs/flow_workdirs/raft_ycbv_flow_mask_mixpbr_normaug_d50_filter20_bs32_grad1_200k_ft/posecnn_jitter30-1x'
#     )
# )
steps = 100000
interval = steps//10
...
work_dir = 'work_dirs/raft_ycbv_pbr'