...
def get_args():
    parser = argparse.ArgumentParser(
        description='Download the model provided by mmflow and convert the model state dict which can be loaded in Unsuper6D project')
...
if __name__ == '__main__':
    ...
    save_path = osp.join(torch.hub.get_dir(), model_name)
